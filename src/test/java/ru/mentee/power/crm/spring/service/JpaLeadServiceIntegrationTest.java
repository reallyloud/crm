...
class JpaLeadServiceIntegrationTest {
    ...
    void update_shouldModifyExistingLead() {
        ...
        Lead updated = leadService.update(id, "Обновленный", "updated@email.com",
                "999999", "НоваяКомпания", LeadStatus.CONTACTED);
    ...
    void update_shouldThrowWhenNotFound() {
        ...
        assertThatThrownBy(() -> leadService.update(nonExistentId, "name", "email@t.com",
                "123", "comp", LeadStatus.NEW))
                .isInstanceOf(ResponseStatusException.class);
    }
