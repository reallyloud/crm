...
class LeadEqualsHashCodeTest {
    ...
    void shouldBeSymmetric_whenEqualsCalledOnTwoObjects() {
        ...
        Lead firstLead = new Lead(randomUUID, "ivan@mail.ru", "+7123", "TechCorp", "NEW");
        Lead secondLead = new Lead(randomUUID, "ivan@mail.ru", "+7123", "TechCorp", "NEW");
    ...
    void shouldBeTransitive_whenEqualsChainOfThreeObjects() {
        ...
        Lead firstLead = new Lead(randomUUID, "ivan@mail.ru", "+7123", "TechCorp", "NEW");
        Lead secondLead = new Lead(randomUUID, "ivan@mail.ru", "+7123", "TechCorp", "NEW");
        Lead thirdLead = new Lead(randomUUID, "ivan@mail.ru", "+7123", "TechCorp", "NEW");
    ...
    void shouldWorkInHashMap_whenLeadUsedAsKey() {
        // Given
        UUID randomUUID = UUID.randomUUID();
        Lead keyLead = new Lead(randomUUID, "ivan@mail.ru", "+7123", "TechCorp", "NEW");
        Lead lookupLead = new Lead(randomUUID, "ivan@mail.ru", "+7123", "TechCorp", "NEW");
