...
class LeadEqualsHashCodeTest {
    ...
    void shouldBeSymmetric_whenEqualsCalledOnTwoObjects() {
        ...
        Lead firstLead = new Lead(randomUUID, contact, "+7123", LeadStatus.NEW);
        Lead secondLead = new Lead(randomUUID, contact, "+7123", LeadStatus.NEW);
    ...
    void shouldBeTransitive_whenEqualsChainOfThreeObjects() {
        ...
        Lead firstLead = new Lead(randomUUID, contact, "+7123", LeadStatus.NEW);
        Lead secondLead = new Lead(randomUUID, contact, "+7123", LeadStatus.NEW);
        Lead thirdLead = new Lead(randomUUID, contact, "+7123", LeadStatus.NEW);
    ...
    void shouldReturnFalse_whenEqualsComparedWithNull() {
        ...
        Lead lead = new Lead(UUID.randomUUID(), contact, "+7123", LeadStatus.NEW);
    ...
    void shouldWorkInHashMap_whenLeadUsedAsKey() {
        ...
        Lead keyLead = new Lead(randomUUID, contact, "+7123", LeadStatus.NEW);
        Lead lookupLead = new Lead(randomUUID, contact, "+7123", LeadStatus.NEW);
    ...
    void shouldNotBeEqual_whenIdsAreDifferent() {
        ...
        Lead lead1 = new Lead(UUID.randomUUID(), contact1, "+7123", LeadStatus.NEW);
        Lead lead2 = new Lead(UUID.randomUUID(), contact2, "+7123", LeadStatus.NEW);
